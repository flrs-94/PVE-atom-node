...
echo "   - Enable AES-NI crypto acceleration (System → Advanced → Misc → Cryptographic Hardware)"
echo "   - Optional: load modules now → kldload aesni; kldload cryptodev"
echo "   - Note: pfSense Plus 2.8.1 has no QAT kernel modules; QAT not available on this build"
echo "   - Configure IPsec/OpenVPN using AES-NI acceleration"
echo ""
echo "📚 Documentation:"
