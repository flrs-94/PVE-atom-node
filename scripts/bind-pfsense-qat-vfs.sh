#!/bin/bash
# Bind QAT VFs 3-6 to vfio-pci for pfSense VM passthrough
# This script is called manually or by systemd service on boot

VFS=("0000:01:01.3" "0000:01:01.4" "0000:01:01.5" "0000:01:01.6")

echo "Binding QAT VFs (AE1) to vfio-pci for pfSense VM..."
...
echo ""
echo "QAT VF binding complete (pfSense AE1)!"
echo ""
lspci -k -s 01:01.3 | grep "Kernel driver"
lspci -k -s 01:01.4 | grep "Kernel driver"
lspci -k -s 01:01.5 | grep "Kernel driver"
lspci -k -s 01:01.6 | grep "Kernel driver"
